...
le_gender = joblib.load("label-encoder_gender.pkl")
le_diabetic = joblib.load("label-encoder_diabetic.pkl")
le_smoker = joblib.load("label-encoder_smoker.pkl")
...
st.write("Enter the details below to extimate your insurance payment amount")
